...
import 'package:vayroll/widgets/country_code/country_code.dart';
...
class _SelectionDialogState extends State<SelectionDialog> {
  ...
  Widget _buildEmptySearchWidget(BuildContext context) {
    ...
    return Center(
      child: Text(context.appStrings!.noCountryFound),
    );
  }
  ...
  void _filterElements(String s) {
    ...
    s = s.toUpperCase();
    setState(() {
      filteredElements = widget.elements.where((e) => e.name!.toUpperCase().startsWith(s)).toList();
    });
    //filteredElements.sort((a, b) => a.dialCode.compareTo(b.dialCode));
  }
