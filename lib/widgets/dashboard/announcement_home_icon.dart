...
class AnnouncementHomeIcon extends StatelessWidget {
  final String? employeeId;
  AnnouncementHomeIcon({Key? key, required this.employeeId}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return IconButton(
      icon: Stack(
        ...
        children: [
          SvgPicture.asset(VPayIcons.announcement, fit: BoxFit.none),
          CustomFutureBuilder<BaseResponse<int>>(
            initFuture: () => ApiRepo().getUnreadAnnouncementsCount(employeeId),
      ...
      onPressed: () => Navigation.navToAnnouncements(context),
    );
  }
}
