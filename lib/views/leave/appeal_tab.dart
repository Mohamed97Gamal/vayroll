...
class AppealRequestsLeaveTab extends StatefulWidget {
  @override
  State<AppealRequestsLeaveTab> createState() => _AppealRequestsLeaveTabState();
}

class _AppealRequestsLeaveTabState extends State<AppealRequestsLeaveTab> {
  int? appealLenght;
  ...
  Widget build(BuildContext context) {
    return CustomPagedListView<Appeal>(
      initPageFuture: (pageKey) async {
        ...
        appealLenght = (appealLenght ?? 0) + (appealResponse.result?.records?.length ?? 0);
